...
export default function SuccessToast({ show, message, onClose, duration = 2500 }) {
    useEffect(() => {
        if (!show) return;
    ...
    return (
        <div className="fixed top-5 right-5 z-[9999]">
            <div className="rounded-xl border border-emerald-500/30 bg-white shadow-lg px-4 py-3 min-w-[260px]">
