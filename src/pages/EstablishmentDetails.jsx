                ...
                >
                    <div className="flex flex-col h-full">
                        ...
                        <div className="flex-1 min-h-0 px-4 pt-4 pb-4">
                            ...
                            <div className="rounded-xl overflow-hidden border border-sky-200 bg-white h-full flex flex-col min-h-0">
                                ...
                                <div className="flex-1 min-h-0 px-4 pb-4">
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-full min-h-0">
                                        ...
                                        <div className="lg:col-span-8 min-h-0">
                                            <div className="h-full min-h-0 overflow-auto scroll-hover">
                                                {loading && !overview ? (
                                        ...
                                        <div className="lg:col-span-4 min-h-0">
                                            <div className="rounded-2xl bg-white border border-slate-100 shadow-sm overflow-auto scroll-hover h-full min-h-0">
                                                <div className="p-4">
                                                ...
                                                {/* Sabeel details mini */}
                                                <div className="flex-1 min-h-0 overflow-auto px-4 pb-4 scroll-hover">
